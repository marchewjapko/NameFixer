...
public class SecondNameRepositoryTests
{
    ...
    private static SecondNameRepository _repository = null!;

    public SecondNameRepositoryTests()
    {
        OptionsMock
    ...
    public void Setup()
    {
        _repository = new SecondNameRepository(
            OptionsMock.Object,
    ...
    public async Task ShouldInitialize_ShouldReadFromLocalFile()
    {
        ...
        FileReaderMock
            .Setup(
                x => x.ReadCsvFile<SecondNameDatasetModel>(
